...
import { Container, Section, SectionHeading, IconBadge } from "@/components/ui";
import { PageHero } from "@/components/PageHero";
import { CTABand } from "@/components/CTABand";
import { Icon } from "@/lib/icons";
import { articles, resourceLinks } from "@/content/site";
...
export default function ResourcesPage() {
  return (
    <>
      ...
      <Section tone="white">
        <Container>
          <SectionHeading eyebrow="Curated links" title="Outside resources we trust" intro="A hand-picked collection of talks, articles, and tools Dr. Sanford and the Change-Well team recommend for deeper learning and support." />
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {resourceLinks.map((group) => (
              <div key={group.heading} className="card flex flex-col p-6">
                <h3 className="font-display text-lg text-navy">{group.heading}</h3>
