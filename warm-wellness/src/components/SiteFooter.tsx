...
// URL of the (separately deployed) admin portal. Override per-environment with
// NEXT_PUBLIC_ADMIN_URL; defaults to the local CMS dev server.
      ...
      <div className="mx-auto max-w-6xl px-5 sm:px-8 py-14">
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-white/50">
          ...
          <div className="flex gap-5">
            ...
            <a href={adminUrl} target="_blank" rel="noopener noreferrer" className="hover:text-white/80">Staff Login</a>
          </div>
        </div>
      </div>
    </footer>
